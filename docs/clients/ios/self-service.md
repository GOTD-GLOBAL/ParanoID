...
limits. Inclusion of its unchanged app tests is inferred from the contributor's
[4066f36 full app-target receipt](../../project/evidence/ios-client-20260918/mac-receipt-pr50-4066f36.md),
not a separately retrieved per-suite log or device evidence.
