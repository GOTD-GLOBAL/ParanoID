...
ARTIFACTS = (
    ...
    ('error_prone_annotations-2.26.0.jar', 'google', 'com/google/errorprone/error_prone_annotations/2.26.0/error_prone_annotations-2.26.0.jar',
    ...
    ('listenablefuture-1.0.jar', 'google', 'com/google/guava/listenablefuture/1.0/listenablefuture-1.0.jar',
