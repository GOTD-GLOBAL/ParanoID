...
final class ConnectionCaptionTests: XCTestCase {
    func testTheOutboxLineAgreesWithItsNumber() {
        let expected: [(Int, String)] = [
            ...
            (3, "3 сообщения ожидают отправки"),
