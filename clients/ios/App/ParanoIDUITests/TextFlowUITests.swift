...
/// The file rendezvous with `clients/ios/test_sim_text.py`.
///
...
/// assertion was just made about, and what lets the test wait for the peer's
/// own core instead of for a wall clock.
///
/// Nothing secret crosses it: a screenshot name, a public account, and the
/// synthetic texts of this run.
private struct Rendezvous {
    let directory: URL
